...
If we condition on C, the path between A and B is not blocked. They are d-connected.
...
Die Variable "Schäden am Auto" ist ein Nachfolger des Colliders "Unfall". D und A sind d-seperated gegeben U, aber d-connected, gegeben S.
